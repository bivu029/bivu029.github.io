...
_1628: f => finalizeWrapper(f,x0 => dartInstance.exports._1628(f,x0)),
...
_1719: s => stringToDartString(JSON.stringify(stringFromDartString(s))),
_1720: s => printToConsole(stringFromDartString(s)),
_1722: () => globalThis.performance,
_1723: () => globalThis.JSON,
_1724: x0 => x0.measure,
_1725: x0 => x0.mark,
_1726: (x0,x1,x2,x3) => x0.measure(x1,x2,x3),
_1727: (x0,x1,x2) => x0.mark(x1,x2),
_1728: (x0,x1) => x0.parse(x1),
_1729: (o, t) => o instanceof t,
_1731: f => finalizeWrapper(f,x0 => dartInstance.exports._1731(f,x0)),
_1732: f => finalizeWrapper(f,x0 => dartInstance.exports._1732(f,x0)),
_1733: o => Object.keys(o),
_1734: (ms, c) =>
              setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
_1735: (handle) => clearTimeout(handle),
_1736: (ms, c) =>
          setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
_1737: (handle) => clearInterval(handle),
_1738: (c) =>
              queueMicrotask(() => dartInstance.exports.$invokeCallback(c)),
_1739: () => Date.now(),
_1740: () => new XMLHttpRequest(),
_1741: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
_1742: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
_1743: (x0,x1) => x0.send(x1),
_1744: x0 => x0.abort(),
_1745: x0 => x0.getAllResponseHeaders(),
_1752: f => finalizeWrapper(f,x0 => dartInstance.exports._1752(f,x0)),
_1753: f => finalizeWrapper(f,x0 => dartInstance.exports._1753(f,x0)),
_1774: (x0,x1) => x0.appendChild(x1),
_1775: (x0,x1) => x0.item(x1),
_1776: (a, i) => a.push(i),
_1777: (a, i) => a.splice(i, 1)[0],
_1780: a => a.pop(),
...
_1799: s => s.trimLeft(),
_1800: s => s.trimRight(),
_1801: (s, n) => s.repeat(n),
_1802: (s, p, i) => s.indexOf(p, i),
_1803: (s, p, i) => s.lastIndexOf(p, i),
_1804: (o, offsetInBytes, lengthInBytes) => {
      var dst = new ArrayBuffer(lengthInBytes);
      new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
      return new DataView(dst);
    },
_1805: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
_1806: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
_1807: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
_1808: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
_1809: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
_1810: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
_1811: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
_1813: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
_1814: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
_1815: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
_1816: Object.is,
_1817: (t, s) => t.set(s),
_1819: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
_1821: o => o.buffer,
_1822: o => o.byteOffset,
_1823: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
_1824: (b, o) => new DataView(b, o),
_1825: (b, o, l) => new DataView(b, o, l),
_1826: Function.prototype.call.bind(DataView.prototype.getUint8),
_1827: Function.prototype.call.bind(DataView.prototype.setUint8),
_1828: Function.prototype.call.bind(DataView.prototype.getInt8),
_1829: Function.prototype.call.bind(DataView.prototype.setInt8),
_1830: Function.prototype.call.bind(DataView.prototype.getUint16),
_1831: Function.prototype.call.bind(DataView.prototype.setUint16),
_1832: Function.prototype.call.bind(DataView.prototype.getInt16),
_1833: Function.prototype.call.bind(DataView.prototype.setInt16),
_1834: Function.prototype.call.bind(DataView.prototype.getUint32),
_1835: Function.prototype.call.bind(DataView.prototype.setUint32),
_1836: Function.prototype.call.bind(DataView.prototype.getInt32),
_1837: Function.prototype.call.bind(DataView.prototype.setInt32),
_1840: Function.prototype.call.bind(DataView.prototype.getBigInt64),
_1841: Function.prototype.call.bind(DataView.prototype.setBigInt64),
_1842: Function.prototype.call.bind(DataView.prototype.getFloat32),
_1843: Function.prototype.call.bind(DataView.prototype.setFloat32),
_1844: Function.prototype.call.bind(DataView.prototype.getFloat64),
_1845: Function.prototype.call.bind(DataView.prototype.setFloat64),
_1851: s => stringToDartString(stringFromDartString(s).toUpperCase()),
_1852: s => stringToDartString(stringFromDartString(s).toLowerCase()),
_1854: (s, m) => {
          try {
...
_1899: l => arrayFromDartList(Uint8Array, l),
...
_1909: stringFromDartString,
_1910: stringToDartString,
_1911: () => ({}),
_1912: () => [],
_1913: l => new Array(l),
_1914: () => globalThis,
...
_1941: (o, p) => o[p],
_1945: () => globalThis.window,
_1966: x0 => x0.matches,
_1970: x0 => x0.platform,
_1975: x0 => x0.navigator,
_1982: x0 => x0.status,
_1983: (x0,x1) => x0.responseType = x1,
_1985: x0 => x0.response,
_1989: () => globalThis.window.flutterCanvasKit,
_2023: (x0,x1) => x0.withCredentials = x1,
_2026: x0 => x0.responseURL,
_2027: x0 => x0.status,
_2028: x0 => x0.statusText,
_2029: (x0,x1) => x0.responseType = x1,
_2031: x0 => x0.response,
_2109: x0 => x0.style,
_2597: (x0,x1) => x0.src = x1,
_2691: x0 => x0.videoWidth,
_2692: x0 => x0.videoHeight,
_2695: (x0,x1) => x0.playsInline = x1,
_2735: x0 => x0.error,
_2736: (x0,x1) => x0.src = x1,
_2737: x0 => x0.src,
_2744: (x0,x1) => x0.preload = x1,
_2746: x0 => x0.buffered,
_2749: (x0,x1) => x0.currentTime = x1,
_2750: x0 => x0.currentTime,
_2751: x0 => x0.duration,
_2755: (x0,x1) => x0.playbackRate = x1,
_2762: (x0,x1) => x0.autoplay = x1,
_2764: (x0,x1) => x0.loop = x1,
_2766: (x0,x1) => x0.controls = x1,
_2768: (x0,x1) => x0.volume = x1,
_2770: (x0,x1) => x0.muted = x1,
_2781: x0 => x0.code,
_2782: x0 => x0.message,
_2853: x0 => x0.length,
...
_3388: (x0,x1) => x0.charset = x1,
_3788: () => globalThis.window,
_3868: x0 => x0.navigator,
_4349: x0 => x0.userAgent,
_8679: x0 => x0.length,
_8763: () => globalThis.document,
_8854: x0 => x0.head,
_9219: (x0,x1) => x0.id = x1,
_9230: x0 => x0.children,
_12045: (x0,x1) => x0.border = x1,
_12483: (x0,x1) => x0.height = x1,
_13171: (x0,x1) => x0.width = x1,
_13856: x0 => x0.name,
_13857: x0 => x0.message
    };
